...
export const INTERLUDE1_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    actId: 5,
    type: 'kill',
    instruction: 'Navigate The Blackwood and kill Siora, Blade of the Mists.',
    questName: 'Recruit the Ezomytes',
    questType: 'main',
    miniMap: {
      layoutType: 'maze',
  ...
  },
  {
    ...
    actId: 5,
    type: 'kill',
    instruction: 'MUST DO: Kill Oswin, the Dread Warden in Wolvenhold (+2 Passive Skill Points).',
    questType: 'side',
  ...
  },
  {
    ...
    actId: 5,
    type: 'kill',
    instruction: 'Kill Lady Elswyth and Thane Wulfric (Holten Estate finale — Interlude 1 bosses).',
    questName: 'Recruit the Ezomytes',
    questType: 'main',
...
export const INTERLUDE2_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    actId: 6,
    type: 'interact',
    instruction: 'MUST DO: Find the Molten One\'s Gift altar — interact for +5% Maximum Life.',
    questType: 'side',
  ...
  },
  {
    ...
    actId: 6,
    type: 'kill',
    instruction: 'Kill Vornas, the Fell Flame at the Galai Gates.',
    questName: 'Recruit the Maraketh',
    questType: 'main',
    miniMap: {
      layoutType: 'linear',
  ...
  },
  {
    ...
    actId: 6,
    type: 'interact',
    instruction: 'MUST DO: Find and interact with the Seven Pillars in Qimah — choose your boon.',
    questType: 'side',
  ...
  },
  {
    ...
    actId: 6,
    type: 'kill',
    instruction: 'Clear Qimah Reservoir — kill final boss to complete Interlude 2.',
    questName: 'Recruit the Maraketh',
    questType: 'main',
    isQuestComplete: true,
    miniMap: {
...
export const INTERLUDE3_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    actId: 7,
    type: 'interact',
    instruction: 'MUST DO: Find Elder Madox in Kriar Peaks — choose a Unique Item reward.',
    questType: 'side',
  ...
  },
  {
    ...
    actId: 7,
    type: 'kill',
    instruction: 'MUST DO: Kill The Abominable Yeti in Howling Caves (+2 Passive Skill Points).',
    questType: 'side',
    reward: { type: 'skill_point', amount: 2, description: '+2 Passive Skill Points' },
  ...
  },
  {
    ...
    actId: 7,
    type: 'kill',
    instruction: 'Kill Stormgore, the Guardian and Rakkar, the Frozen Talon — Interlude 3 finale bosses.',
    questName: 'Recruit the Vaal',
    questType: 'main',
    isQuestComplete: true,
    miniMap: {
