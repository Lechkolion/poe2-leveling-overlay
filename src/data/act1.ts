...
export const ACT1_STEPS: GuideStep[] = [
  ...
  // ─── CLEARFELL ──────────────────────────────────────────────────────────
  {
    ...
    questName: 'Beira of the Rotten Pack',
    questType: 'side',
    miniMap: {
      layoutType: 'open',
  ...
  // ─── THE GRELWOOD ────────────────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'talk',
    instruction: 'Find exits to Grim Tangle AND Red Vale — grab both waypoints (enter zone, activate, portal back). Then speak to Una at the Tree of Souls (NORTHEAST of Grelwood — large twisted tree on a stone platform).',
    questName: 'Secrets in the Dark',
    questType: 'main',
  ...
  // ─── THE RED VALE ────────────────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'interact',
    instruction: 'Find and activate all 3 Obelisks of Rust (1st and 2nd in the lower-east area, 3rd to the northwest). Fight enemy waves at each, collect Rune of Power (1/3, 2/3, then 3/3 from the Rust King at the 3rd).',
    questName: 'Secrets in the Dark',
    questType: 'main',
    miniMap: {
      layoutType: 'open',
  ...
  },
  {
    ...
    actId: 1,
    type: 'interact',
    instruction: 'Waypoint to Grelwood → return to Tree of Souls (NORTHEAST area). Place all 3 Runed Spikes on the Rune Seals — completes Secrets in the Dark.',
    questName: 'Secrets in the Dark',
    questType: 'main',
    isQuestComplete: true,
  ...
  // ─── THE HUNTING GROUNDS ────────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'kill',
    instruction: 'MANDATORY SKILL POINTS: Kill The Crowbell in Hunting Grounds (+2 Passive Skill Points). After kill → exit east to Freythorn.',
    questName: 'The Crowbell',
    questType: 'side',
    detail: 'The Crowbell roams the Hunting Grounds (northern half). Large bird creature — watch for dive bomb attack. After kill, find the Freythorn portal at the east edge.',
  ...
  // ─── FREYTHORN ──────────────────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'kill',
    instruction: 'Enter Freythorn (east exit of Hunting Grounds). MUST DO: Ominous Altars — complete 3 Ritual Altars, then return to the 4th (was sealed by black clouds) — King in the Mists spawns there. Drops Gembloom Skull → consume for +30 Spirit.',
  ...
  // ─── OGHAM FARMLANDS ────────────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'pickup',
    instruction: 'MANDATORY SKILL POINTS: Find Una\'s Lute in Ogham Farmlands — usually CENTER-SOUTH of the zone, near abandoned farmhouses / hay bales (glowing golden item on the ground).',
  ...
  // ─── OGHAM VILLAGE (Hub 2) ──────────────────────────────────────────────
  {
    ...
    actId: 1,
    type: 'pickup',
    instruction: 'Find Smithing Tools in Ogham Village — look for Renly\'s Workshop checkpoint (small building, usually NORTH side of the village). First character per league only — unlocks Salvaging Bench.',
    questName: "Renly's Tools",
    questType: 'side',
    optional: true,
  ...
  },
  {
    ...
    actId: 1,
    type: 'talk',
    instruction: 'Talk to Leitis (who you freed — she\'s standing in the village square after her cage) and other Ogham Village NPCs — pick up "The Mad Wolf of Ogham".',
  ...
  },
  {
    ...
    questName: 'Candlemass, the Living Rite',
    questType: 'side',
