...
export const ACT4_STEPS: GuideStep[] = [
  ...
  // ─── WHAKAPANU ISLAND ────────────────────────────────────────────────────
  {
    ...
    actId: 4,
    type: 'kill',
    instruction: 'OPTIONAL (IMPORTANT TIMING): Find the Shark Pit — ACROSS Whakapanu Island from the dock, on a separate beach with gaps in the rock formation. Move close to the water to trigger the Great White One fight. Loot the Shark Fin. MUST do this BEFORE Arastas, or only after the entire main quest is done.',
    optional: true,
  ...
  },
  {
    ...
    actId: 4,
    type: 'interact',
    instruction: 'OPTIONAL: In Singing Caverns, find the Beckoning Clam (large glowing clam in a side chamber). Complete the counter to loot the Humming Pearl — turn in to Rog back in town for a rare amulet with +8 all elemental resistance.',
    optional: true,
  ...
  },
  {
    ...
    actId: 4,
    type: 'interact',
    instruction: 'OPTIONAL: Find the Voltaxic Spire on Isle of Kin — large exposed sulphur rock formation in the open. Interact for a zone-buff: 30% Movement, 30% damage as extra Lightning, 15% Elemental Resistances.',
  ...
  },
  {
    ...
    actId: 4,
    type: 'kill',
    instruction: 'OPTIONAL: Find the Beast Pen on Isle of Kin (fenced sub-area, usually side of the main path). Free and kill Mimbok the Enslaved.',
    questName: 'Isle of Kin Bonuses',
    questType: 'side',
    optional: true,
